...
const Donate: React.FunctionComponent<IDonateProps> = ({
  sendDonation,
  sendDescription,
  details,
}) => {
  ...
  return (
    ...
    >
      ...
      <DonateForm
        tellTitle={t("donate:tell-title")}
        emailLabel={t("donate:email-label")}
        emailPlaceholder={t("donate:email-placeholder")}
